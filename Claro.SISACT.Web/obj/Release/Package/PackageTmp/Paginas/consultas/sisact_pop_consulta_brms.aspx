...
<body>
    ...
    <table cellspacing="1" cellpadding="0" border="0">
        ...
        <tr>
            <td><!--PROY-24724-IDEA-28174 - INICIO-->
                ...
                </asp:DataGrid><!--PROY-24724-IDEA-28174 - FIN-->                
            </td>
        </tr>
    </table>
    <br />
        ...
        <tr>
            <td>
                <asp:DataGrid ID="dgCliente" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        <%--PROY-32439 MAS INI--%>
                        <asp:BoundColumn DataField="ANTIGUEDAD" HeaderText="Antigüedad de Deuda"></asp:BoundColumn>
                        <asp:BoundColumn DataField="ANTIGUEDAD_MONTO" HeaderText="Antigüedad Monto en Disputa"></asp:BoundColumn>
                        <%--PROY-32439 MAS FIN--%>
                        ...
                        <%--PROY-32439 MAS FIN--%>
                        <%--PROY-31948 INI--%>
                        <asp:BoundColumn DataField="CANT_MAX_CUO_SIS" HeaderText="Cantidad Maxima de Cuotas Pendientes en Sistemas"></asp:BoundColumn>
                        <asp:BoundColumn DataField="CANT_MAX_CUO_ULT" HeaderText="Cantidad Maxima de Cuotas Pendientes Ultimas Ventas"></asp:BoundColumn>
                        <asp:BoundColumn DataField="CANT_PLAN_CUO_SIS" HeaderText="Cantidad de Planes con Cuotas Pendientes en Sistema"></asp:BoundColumn>
                        <asp:BoundColumn DataField="CANT_PLAN_CUO_ULT" HeaderText="Cantidad de Planes con Cuotas Pendientes Ultimas Ventas"></asp:BoundColumn>
                        <%--PROY-31948 FIN--%>
                        ...
                        <asp:BoundColumn DataField="DEUDA" HeaderText="Deuda"></asp:BoundColumn> <%--PROY-29121--%>
                        ...
                        <%--PROY-140579 RU09 NN se agrega FLAG_WHITELIST--%>
                        ...
                        <%--PROY-32439 MAS FIN--%>
                        <asp:BoundColumn DataField="RIEGO" HeaderText="Riesgo"></asp:BoundColumn> <%--PROY-140257--%>
                        <%--PROY-140230-MAS-INI--%>
                        <asp:BoundColumn DataField="SEGMENTO" HeaderText="Segmento"></asp:BoundColumn>
                        <%--PROY-140230-MAS-FIN--%>
                        <%--PROY-31948 INI--%>
                        <asp:BoundColumn DataField="MONTO_PEND_CUO_SIS" HeaderText="Monto Pendiente en Cuotas en Sistema"></asp:BoundColumn>
                        <asp:BoundColumn DataField="MONTO_PEND_CUO_ULT" HeaderText="Monto Pendiente en Cuotas Ultimas Ventas"></asp:BoundColumn>
                        <%--PROY-31948 FIN--%>
...
<%-- PROY-32438 --INI--%>
                        <asp:BoundColumn DataField="TIPCONTRIBUYENTE" HeaderText="Tipo de Contribuyente">
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="NOMCOMERCIAL" HeaderText="Nombre Comercial del Contribuyente">
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="FEC_INIACTIVIDADES" HeaderText="Fecha de Inicio de Actividades del Contribuyente">
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="ESTCONTRIBUYENTE" HeaderText="Estado del Contribuyente">
                        </asp:BoundColumn>
                       <%--<asp:BoundColumn DataField="ACTIVIDADES_ECONOMICAS" HeaderText="Actividades Econ&#243;micas del Contribuyente">
                        </asp:BoundColumn>--%>
                        <asp:BoundColumn DataField="CONDCONTRIBUYENTE" HeaderText="Condici&#243;n del Contribuyente">
                        </asp:BoundColumn>
                        ...
                        <asp:BoundColumn DataField="CIIUCONTRIBUYENTE" HeaderText="CIU del Contribuyente">
                        </asp:BoundColumn>
            ...
            <td>
                <asp:DataGrid ID="dgRRLL" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="NUMERO_DOCUMENTO" HeaderText="Nro. de Documento"></asp:BoundColumn>
                        <%--INI 32438--%>
                        <asp:BoundColumn DataField="CARGO_RRLL" HeaderText="Cargo de los Representantes Legales">
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="FECHA_NOMBRAMIENTO_RRLL" HeaderText="Fecha de Nombramiento de los Representates Legales">
                        </asp:BoundColumn>
                        <asp:BoundColumn DataField="MESES_NOMBRAMIENTO_RRLL" HeaderText="Cantidad de meses desde el nombramiento del RRLL">
                        </asp:BoundColumn>
                        <%--<-- FIN 32438-->--%>
                    </Columns>
                </asp:DataGrid>
            ...
            <td><!--PROY-24724-IDEA-28174 - INICIO-->
                <asp:DataGrid ID="dgOferta" runat="server" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <%--##PROY-140335 RF1--%>
                        <asp:BoundColumn DataField="FLAG_CP" HeaderText="Flag Consulta Previa"></asp:BoundColumn>
                        <%--##--%>
                        ...
                        <%--##PROY-140743--%>
                        <asp:BoundColumn DataField="PRODUCTO_CUENTA_FACTURAR" HeaderText="Tipo de Producto a Facturar" Visible="False"></asp:BoundColumn>
                        <asp:BoundColumn DataField="PROMOCIONES" HeaderText="Promociones" Visible="False"></asp:BoundColumn>                        
                        <%--##--%>
        ...
        <tr>
            <td>
                <asp:DataGrid ID="dgPlanActual" runat="server" AutoGenerateColumns="False">
                    ...
                    <HeaderStyle Wrap="False" HorizontalAlign="Center" CssClass="TablaTitulos"></HeaderStyle>
                    <Columns>
                        <asp:BoundColumn DataField="CANT_PEND_CUO_RENO" HeaderText="Cantidad de Cuotas Pendientes"></asp:BoundColumn>  <%--PROY-31948--%>
                        ...
                        <%--PROY-140579 RU09 NN FIN--%>
                        <asp:BoundColumn DataField="MONTO_PEND_CUO_RENO" HeaderText="Monto Pendiente en Cuotas"></asp:BoundColumn> <%--PROY-31948--%>
                        <%--PROY-140579 RU09 se agrega ACTI_LINEA_RENO--%> 
                        <asp:BoundColumn DataField="ACTI_LINEA_RENO" HeaderText="Motivo de activaci&#243;n de l&#237;nea a renovar"></asp:BoundColumn>
                        <asp:BoundColumn DataField="PLAZO_ACUERDO" HeaderText="Plazo de Acuerdo"></asp:BoundColumn>
                        <asp:BoundColumn DataField="TIEMPO_PERMANENCIA" HeaderText="Tiempo de Permanencia de la Renovacion"></asp:BoundColumn> 
                    </Columns>
                </asp:DataGrid>
            </td>
        </tr>
