...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function mostrarServicios(idSol, orden, idProducto) {
            ...
            tblLineaFact.style.display = 'none'; //PROY-140743
        }
        ...
        //PROY-140743 - INICIO
        function mostrarLinea_A_Facturar() {
            document.getElementById('txtProducto').value = getValue('hidtxtProducto');
            document.getElementById('txtLinea').value = getValue('hidtxtLinea');
            tblServicio.style.display = 'none';
            tblEquipo.style.display = 'none';
            tblCuotas.style.display = 'none';
            tblLineaFact.style.display = 'inline';
        }
        //PROY-140743 - FIN
    </script>
</head>
<body>
    ...
    <div style="overflow: auto; width: 100%; height: 100%; align: rigth">
        <asp:GridView ID="dgrMovil" runat="server" Width="100%" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Linea a Facturar">
                    <ItemTemplate>
                        <img id="btnLineaFacturar" onclick='javascript:mostrarLinea_A_Facturar();'
                        src="../../Imagenes/ico_lupa.gif" style="cursor: hand;" alt="LineaFact">
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="FECHA_ACTIVACION" HeaderText="Fecha Activacion CP" />
                <asp:BoundField DataField="DEUDA_CP" HeaderText="Deuda CP" />
                <asp:BoundField DataField="PRESELECCION" HeaderText="PRE-SELECCION" />
            </Columns>
        </asp:GridView>
    ...
    <table class="Contenido" id="tblLineaFact" style="display: none;" cellspacing="1" cellpadding="0"
        width="400" border="0" align="center">
        <tr>
            <td class="Header">
                &nbsp;Linea a Facturar
            ...
            <td class="Contenido" align="center">
                <table cellspacing="1" cellpadding="0" width="100%" border="0">
                    <tr>
                        ...
                        <td class="Arial10B" style="background-color: white" valign="top">
                            <input class="clsInputDisable" id="txtProducto" style="width: 120px; text-align: right"
                                readonly type="text" />
                        </td>                        
                    </tr>
                    <tr>
                        ...
                        <td class="Arial10B" style="background-color: white" valign="top">
                            <input class="clsInputDisable" id="txtLinea" style="width: 120px; text-align: right"
                                readonly type="text" />
                        </td>                        
                    </tr>
                    <tr>
                        <td align="center" colspan="4">
                            <input class="Boton" id="Button1" style="width: 80px; cursor: hand; height: 17px"
                                onclick="tblLineaFact.style.display = 'none'" type="button" value="Cerrar" />
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <input type="hidden" runat="server" id="hidtxtProducto" />    
    <input type="hidden" runat="server" id="hidtxtLinea" />    
    <%-- PROY-140743 - AE - FIN --%>
