...
function EsValorPermitido(pValor, pValoresPermitidos, pDelimitador) {
    var arrValoresPermitidos = pValoresPermitidos.split(pDelimitador);

    var i;
    for (i = 0; i < arrValoresPermitidos.length; i++) {
