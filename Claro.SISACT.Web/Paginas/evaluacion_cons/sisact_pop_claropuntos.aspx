...
<head runat="server">
    ...
    <!-- agregar los archivos Estilo_General funciones_generales  validaciones-->
    ...
    <script language="javascript" type="text/javascript">
        var constMsgSinClaroPuntos = '<%= ConfigurationManager.AppSettings["constMsgSinClaroPuntos"] %>';
        var requestTipo = '<%=Request.QueryString["tipo"]%>';
    </script>
    <script type="text/javascript" language="JavaScript" src="../../Scripts/Paginas/evaluacion_cons/sisact_pop_claropuntos.js"></script>
</head>
<body>
