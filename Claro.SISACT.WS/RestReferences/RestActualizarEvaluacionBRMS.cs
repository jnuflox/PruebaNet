...
{
    public class RestActualizarEvaluacionBRMS
    {
        public ActualizarEvaluacionBrmsDPResponse actualizarEvaluacionBRMS(ActualizarEvaluacionBrmsDPRequest request)
        {
            string strArchivo = "Log_RestActualizarEvaluacionBRMS";
            ...
            try
            {
                ...
                return RestServiceActualizarEvaluacionBRMS.PostInvoque<ActualizarEvaluacionBrmsDPResponse>("urlActualizarEvaluacionBRMS", paramHeader, request);
            }
            catch (Exception ex)
            {
                _objLog.CrearArchivolog("Excepcion metodo registrarEvaluacionBRMS : " + "---Log_RestActualizarEvaluacionBRMS ---", null, ex);
                throw;
            }
