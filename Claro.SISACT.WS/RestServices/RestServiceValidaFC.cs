...
{
    public static class RestServiceValidaFC
    {
        ...
        public static T PostInvoque<T>(string name, Hashtable objHeader, ValidarProductosFCRequest obj, string usuario, string ipServidor)
        {
            ...
            var parametroURL = string.Format("?tipoDocumento={0}&nroDocumento={1}&planServCodigo={2}&tipoServicio={3}", obj.MessageRequest.body.strTipoDocumento,
            obj.MessageRequest.body.strNroDocumento, obj.MessageRequest.body.strPlanes,  obj.MessageRequest.body.strTipoProducto);
