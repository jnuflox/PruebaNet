...
{
    public class RestServiceRegistrarEvaluacion
    {
        private static WebHeaderCollection GetHeaders(Hashtable table, string usuario, string ipServidor)
        {
            GeneradorLog _objLog = null;
            _objLog = new GeneradorLog("Metodo GetHeaders", null, null, "log_ProyMejoraPortabilidad");
        ...
        {
            GeneradorLog objLog = new GeneradorLog(null, "Inicio metodo  PostInvoque", null, "log_ProyMejoraPortabilidad");
            ...
            objLog.CrearArchivolog("PROY-MejoraPortabilidad Cadena data  -->" + data.ToString(), "", null);
            byte[] byteArray = Encoding.UTF8.GetBytes(data);
            request.Timeout = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["ConsMejorasPorta_TimeOut"]);
            objLog.CrearArchivolog(string.Format("Valor de TimeOut ConsMejorasPorta_TimeOut: " + request.Timeout), "", null);
