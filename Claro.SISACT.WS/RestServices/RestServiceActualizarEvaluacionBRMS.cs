...
{
    public static class RestServiceActualizarEvaluacionBRMS
    {
        private static WebHeaderCollection GetHeaders(Hashtable table)
        {
            GeneradorLog _objLog = null;
            _objLog = new GeneradorLog("Metodo GetHeaders", null, null, "log_RestServiceActualizarEvaluacionBRMS");
        ...
        {
            GeneradorLog objLog = new GeneradorLog(null, "Inicio metodo  PostInvoque", null, "RestServiceActualizarEvaluacionBRMS");
            ...
            using (Stream stream = ws.GetResponseStream())
            {
                ...
                objLog.CrearArchivolog("PROY-BRMS RestServiceActualizarEvaluacionBRMS() ResponseString  Return JSON: -->" + responseString.ToString(), "", null);
