...
{
    public static class RestServiceActualizarHistoricoProactiva
    {
        private static WebHeaderCollection GetHeaders(Hashtable table)
        {
            GeneradorLog _objLog = null;
            _objLog = new GeneradorLog("Metodo GetHeaders", null, null, "log_RestServiceActualizarHistoricoProactiva");
        ...
        {
            GeneradorLog objLog = new GeneradorLog(null, "Inicio metodo  PostInvoque", null, "RestServiceActualizarHistoricoProactiva");
            ...
            objLog.CrearArchivolog(string.Format("Valor de TimeOut strProactivaTimeOut: " + request.Timeout), "", null);
            ...
            using (Stream stream = ws.GetResponseStream())
            {
                ...
                objLog.CrearArchivolog("PROY-BRMS Proactiva RestServiceActualizarHistoricoProactiva() ResponseString  Return JSON: -->" + responseString.ToString(), "", null);
