...
namespace Claro.SISACT.Data
{
    public abstract class Conexion
    {
        ...
        internal static ClaroBDConfiguration GeneraConfiguracion<T>(string aplicacion)
        {
            return GeneraConfiguracion<T>(aplicacion, ConfigurationManager.AppSettings[aplicacion]);
        }
     

        internal static ClaroBDConfiguration GeneraConfiguracion<T>(string aplicacion, string archivoConfig)
        {
            ...
            return (ClaroBDConfiguration)_arrConfigurraciones[aplicacion];
        }
